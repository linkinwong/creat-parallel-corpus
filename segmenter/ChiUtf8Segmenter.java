...
// It allows input either from input_file (a file) or consolemode (console/piped input).
...
// Usage: java ChiUtf8Segmenter [-mode1|-mode2|-mode3|-mode4|-mode5] consolemode wordprob_map [numbers_identity_file]
//
...
// consolemode		   Allow user input from console or from piped text
...
//  System.gc();
  ...
  public void segmentConsoleStr(int mode) {
    String segstring, outputstring;

    try {
      outputstring = "";
      String dataline;
      BufferedReader rd = new BufferedReader(new InputStreamReader(System.in, encoding));
      BufferedWriter out = new BufferedWriter(new OutputStreamWriter(System.out, encoding));
	    
      dataline = rd.readLine();
      while(dataline != null) {
        segstring = segmentLine(dataline, seg_separator, mode);
        outputstring += segstring;
        outputstring += "\n";
        dataline = rd.readLine();
      }
...
//  System.gc();
  ...
  public static void printHelp() {
    ...
    System.out.println("Usage: java ChiUtf8Segmenter [-mode1|-mode2|-mode3|-mode4|-mode5] consolemode wordprob_map [numbers_identity_file]\n");
  ...
  public static void main(String[] argv) throws IOException {
    ...
    if(inputfile.equals("consolemode")) {
      segmenter.segmentConsoleStr(mode);
    }
    else {
